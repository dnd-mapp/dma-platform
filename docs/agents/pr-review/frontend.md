...
- [ ] Effects do not run unnecessarily.
- [ ] Memoization is used only where beneficial.
- [ ] Components do not re-render excessively.
- [ ] Keys in lists are stable.
- [ ] Controlled and uncontrolled inputs are not mixed incorrectly.
