...
import { ButtonLinkHarness } from '@dnd-mapp/arcane-ui/components/testing';
...
describe('ButtonLinkComponent', () => {
    ...
    describe('disabled', () => {
        ...
        it('sets aria-disabled and removes from tab order when disabled', async () => {
            ...
            expect(await (await harness.host()).getAttribute('tabindex')).toBe('-1');
        });
    });
});
